public class Item {
    ...
    String createTable = "CREATE TABLE item (itemID SERIAL PRIMARY KEY, name varchar(50), price float, amount int);";
    String insertTable = "";
    insertTable += 
    ...
    "INSERT INTO item (name, price, amount)" + 
    "VALUES ('Utensils', 0, 1);";             
    return createTable + insertTable + grantAccess.access("item");
  }
